                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute right-0 top-1/4 bottom-1/4 w-1 bg-[#FFFFFF] rounded-l"
                    />
                  )}
          ...
          <div className="w-full lg:w-7/12 relative overflow-hidden mt-12 lg:mt-0 min-h-[400px] rounded-2xl border border-white/10 shadow-xl">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {/* Green Badge */}
                <div className="absolute top-0 left-8 bg-[#FFFFFF] text-gray-900 px-3 pt-6 pb-6 flex flex-col items-center justify-center min-w-[70px]" style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 50% 85%, 0 100%)" }}>
                  <Star size={20} className="fill-gray-800 text-gray-800 mb-1" />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <button className="px-10 py-4 bg-gradient-to-r from-[#FFFFFF] to-[#E2E8F0] text-gray-900 font-black text-sm tracking-widest uppercase rounded-lg shadow-[0_10px_30px_-10px_rgba(236,72,153,0.6)] transform hover:scale-105 hover:shadow-[0_15px_40px_-10px_rgba(236,72,153,0.8)] transition-all duration-300">
                    Booking Now
                  </button>
                </div>
              </motion.div>
