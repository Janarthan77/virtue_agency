...
const inputCls =
  "w-full bg-[#0F172A] border border-white/[0.09] rounded-xl px-4 py-3.5 text-gray-200 placeholder-gray-600 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#FFFFFF]/50 focus:border-[#FFFFFF]/60 transition-all duration-300";
          ...
          <Reveal delay={0.2} className="lg:col-span-3">
            <div className="bg-[#1E293B] border border-white/[0.07] rounded-2xl p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="absolute top-0 left-0 right-0 h-[2px]"
                style={{ background: "linear-gradient(90deg, #FFFFFF, #E2E8F0, #FFB800)" }} />
              ...
              {submitted ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Info banner */}
                    <div className="flex gap-3 bg-[#FFFFFF]/8 border border-[#FFFFFF]/20 rounded-xl p-4 text-sm text-gray-300">
                      <Info size={16} className="text-[#FFFFFF] shrink-0 mt-0.5" />
                    ...
                    <button
                      type="submit"
                      className="w-full flex items-center justify-center gap-3 py-4 rounded-xl text-gray-900 font-black text-base tracking-wide transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_16px_40px_-10px_rgba(255,255,255,0.5)]"
                      style={{ background: "linear-gradient(135deg,#FFFFFF,#E2E8F0)" }}
                    >
                    ...
                    <p className="text-center text-[11px] text-gray-600 mt-2">
                      ...
                      <a href="#" className="text-[#FFFFFF] hover:underline">Privacy Policy</a>
                      {" "}&amp;{" "}
                      <a href="#" className="text-[#FFFFFF] hover:underline">Terms of Service</a>
                    </p>
                  </form>
                </>
              )}
